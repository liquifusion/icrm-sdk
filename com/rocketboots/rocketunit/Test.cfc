...
<cfcomponent>
	...
	<!---
		Called from a test function test that an error was raised and to return the error type.
	
		@param	expression	String containing CFML expression to evaluate
	--->
	<cffunction name="raised" returntype="string" output="false">
	...
	<cffunction name="$dump" access="private" output="false" returntype="void">
